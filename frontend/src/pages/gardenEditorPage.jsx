...
var groups = [];
export default class GardenEditorPage extends React.Component{
  constructor(props) {
    super(props);
  ...
  async componentDidMount(){
    ...
    const res = await axios.get('http://localhost:5000/garden-editor', {
      proxy: {
        host: 'localhost',
        port: 5000
      }
    ...
    groups.push((props) => <div className="parent">{props.children}</div>)
